...
class ACNet_app(object):
    ...
    def runANN(self):
        ...
        save(os.path.join(save_path, 'Patches_4D_3x3.npy'), patches_4D)
        ...
        save(os.path.join(save_path, 'TOA_xtesting.npy'), TOA_xtesting_reshape)
        save(os.path.join(save_path, 'angles_xtesting.npy'), angles_xtesting_final)
        save(os.path.join(save_path, 'AOT_xtesting.npy'), AOT_xtesting_reshape)
        ...
        r3 = os.path.join(save_path, 'prediction.tif')
        os.remove(r1)
        os.remove(r2)
        os.remove(r3)
