...
## select excel file match with image file name (one by one)
## generate patches for TOA_angle_AOT and then for iCOR image
## source \\140.116.80.130\home\AC-Net\Arcmap\InsituStation\WorldtoPixel\Testing
GPS_path = filedialog.askopenfilename(title=u'Open XY excel file', filetypes=[("Excel files", ".xlsx .xls")])
dataXY = pd.read_excel(GPS_path, engine='openpyxl') ## you must install openpyxl and defusedxml

## source: \\140.116.80.130\home\AC-Net\Landsat8_Image\matchinsitudates
...
## source: \\140.116.80.130\home\AC-Net\InputforANN\NEWupdateDataset_May2021\dataforTESTING_update22May\Patches4D_Testing
